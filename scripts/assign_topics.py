...
TOPICS = {
    ...
    "topic-work": (
        "Work & Technology", "💼",
        "Twenty years of building things — Windows Live, a patent, satellites, and every gadget along the way",
        "#4b5d78", 8,
    ),
    "topic-transport": (
...
CURATED = {
    ...
    # ── Curated strays from the 2004–2013 backfill ──
    # Seattle: the houseboat years and the 2011 "water photo" / December series
    "talking-about-our-new-shack": "topic-seattle",
    "coast-guard": "topic-seattle",
    "ski": "topic-seattle",
    "earning-my-turns-hiking-up-and-snowboarding-down": "topic-seattle",
    "heritage-tree-grove": "topic-seattle",
    "licensed-dinner-raft": "topic-seattle",
    "seen-better-days": "topic-seattle",
    "rooftop-view-looking-nw": "topic-seattle",
    "removal-of-sunken-house-barge": "topic-seattle",
    "sunset-and-sailboats": "topic-seattle",
    "wet-sidewalk-counts-as-a-water-photo": "topic-seattle",
    "pontoon-boat-on-sea-legs": "topic-seattle",
    "water-with-giordanos-pizza": "topic-seattle",
    "drinking-water-at-an-ethiopian-restaurant": "topic-seattle",
    "the-other-view-of-our-street": "topic-seattle",
    "neighborhood-view": "topic-seattle",
    "sinful-hot-chocolate": "topic-seattle",
    "december-19-at-shores-edge": "topic-seattle",
    "december-18-without-a-beard": "topic-seattle",
    "december-9-with-a-hint-of-frost": "topic-seattle",
    "panoramic-test": "topic-seattle",
    "panoramic-test-2": "topic-seattle",
    "daily-buzz-photo": "topic-seattle",
    # Bay Area: the 2013 move south (America's Cup was on SF Bay)
    "looking-down-mission-creek": "topic-bayarea",
    "preparing-for-the-americas-cup": "topic-bayarea",
    "sitting-on-top-of-the-world": "topic-bayarea",
    # London years
    "no-white-laundry": "topic-london",
    "wicked": "topic-london",
    "dinner-time": "topic-london",
    # Work & technology
    "the-portable-media-player-i-want": "topic-work",
    "portable-media-solution": "topic-work",
    "new-mini-pcs": "topic-work",
    "what-are-people-searching-for": "topic-work",
    "how-much-land-to-power-the-whole-world-with-solar": "topic-work",
    "brians-new-office": "topic-work",
    "hello-world": "topic-work",
    "milosthinking-testing-social-media": "topic-work",
    # Trips
    "entering-ny-ny": "topic-america",
    "in-ny-ny": "topic-america",
    "more-ny-ny": "topic-america",
    "mm-ny": "topic-america",
    "american-junkfood": "topic-america",
    "talking-about-devil-roadkill": "topic-downunder",
    # People and occasions
    "lorie-and-grandma-bunny-at-90": "topic-celebrations",
    "melrose-grill-with-dad": "topic-celebrations",
    "troels-and-david": "topic-celebrations",
    "cheryl-crow-in-concert": "topic-celebrations",
    "december-24-with-a-santa-elf": "topic-celebrations",
    # Dogs
    "muzzled": "topic-piper",
    "december-28-back-at-the-vet": "topic-piper",
    # Cars (paired with "Muddy Volvo" on the same day)
    "dirty": "topic-transport",
    "zero-gravity-experience-parabolic-flights": "topic-transport",
    # Curiosities and link posts
    "brian-in-south-park": "topic-art",
    "tree-from-fungus": "topic-art",
    "msnbcs-40-best-bargain-vacations": "topic-art",
}
...
AUTO_RULES = [
    ...
    ("topic-downunder", [
        ...
        "thailand", "vietnam", "bangkok", "hanoi", "saigon", "phuket",
    ]),
    ("topic-sunshine", [
    ...
    ("topic-work", [
        "microsoft", "windows live", "hotmail", "messenger", "msn", "msdn",
        "bill gates", "techfest", "patent", "patents", "xbox", "zune",
        "nokia", "lumia", "lumina", "kindle", "ultra-mobile", "laptop",
        "tablet", "software", "carl zeiss", "cybershot", "hands-free",
        "salesforce", "dreamforce", "agentforce", "planet labs",
        "my presentation", "conference", "keynote", "demo", "beta",
        "the products i work on", "life at microsoft", "blog at work",
    ]),
    ("topic-art", [
        ...
        "planetarium", "lego", "virtual reality", "comedy", "mockumentary",
        "snl", "superhero", "dalek", "sasquatch", "pirate", "video",
        "videos", "movie", "movies", "documentary",
    ]),
    ...
    ("topic-london", [
        ...
        "english", "britain", "british", "pub", "pubs", "bishops park",
        "windsor", "globe theatre", "west end", "theatre", "flat", "flats",
        "haggis", "uk",
    ]),
    ("topic-seattle", [
        "seattle", "kirkland", "houseboat", "houseboats", "lake union",
        "puget", "bellevue", "redmond", "tacoma", "olympia", "rainier",
        "cascades", "ballard", "fremont", "queen anne", "capitol hill",
        "pike place", "space needle", "washington state", "northwest",
        "orca", "salmon", "dock", "docks", "gasworks", "gassworks",
        "westlake", "elliot bay", "elliott bay", "fairview", "husky",
        "wooden boats", "alpental", "snoqualmie", "longview", "sacajawea",
    ]),
    ("topic-america", [
        ...
        "jones island", "san juan islands", "atlanta", "georgia", "nevada",
        "pennsylvania", "danville", "sacramento", "key largo", "florida keys",
        "powder mountain", "central park",
    ]),
    ("topic-europe", [
        ...
        "vernazza", "monterosso", "borough market", "wales", "milan",
        "milano", "brussels", "mont blanc", "eiffel", "finland", "helsinki",
        "european union",
    ]),
    ("topic-transport", [
        ...
        "sailing", "catamaran", "drawbridge", "draw bridge", "car", "cars",
        "volvo", "fiat", "citroen", "citroën", "taxi", "streetcar",
        "top gear", "sports car", "motorcycle",
    ]),
    ("topic-piper", [
